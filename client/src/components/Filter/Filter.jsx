    ...
    return (
        <div className="main-container">
            <div className="top-bar">
                <h4>
                    Hecha un vistazo a todas las recetas que tenemos para ti
                </h4>
            ...
            <div className="filter-item-img">
                ...
                <div className="filter-img">
                    {Object.entries(dietImages).map(([diet, image]) => (
                        <div key={diet} className="diet-image" onClick={() => handleFilterByDiet({ target: { value: diet } })}>
            ...
            <div className="filter-row">
                ...
                <div className="item-1">
                    ...
                    <select id="puntuation-select" className="filter-select-class" onChange={(event) => handleSortByPuntuation(event)}>
                ...
                <div className="item-2">
                    ...
                    <select id="filter-select" className="filter-select-class" onChange={(event) => handleFilter(event)}>
                ...
                <div className="item-3">
                    ...
                    <select id="sort-select" className="filter-select-class" onChange={(event) => handleSortByName(event)}>
